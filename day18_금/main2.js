...
4. 추가 기능 (시간 여유 시)
    현황 집계 기능:
        페이지 상단 또는 별도의 영역에 실시간 현황판을 추가합니다.
        총 부서 수: 현재 등록된 부서의 총개수를 표시합니다.
        총 사원 수: 현재 등록된 사원의 총인원을 표시합니다.
        오늘 휴가 중인 사원: 현재 날짜 기준으로 휴가를 사용 중인 사원의 이름을 목록으로 표시합니다.

    사원 검색 기능:
        사원 목록 상단에 검색창을 추가합니다.
        사용자가 사원 이름을 입력하면, 해당 이름이 포함된 사원만 목록에 필터링하여 보여줍니다.
